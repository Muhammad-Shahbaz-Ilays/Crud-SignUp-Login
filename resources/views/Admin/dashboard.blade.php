...
<div class="wrapper">
  ...
  <nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item d-none d-sm-inline-block">
        <a href="{{ route('products.create') }}" class="nav-link">Add Record</a>
      </li>
      <li class="nav-item d-none d-sm-inline-block">
        <a href="{{ route('products.showdata') }}" class="nav-link">Show Record</a>
      </li> -->
    </ul>
    <div class="container">
...
@if (Route::has('login'))
    <div class="sm:fixed sm:top-0 sm:right-0 p-6 text-right z-10">
        @auth
            ...
            <a href="{{ route('products.create') }}" class="font-semibold text-gray-600 hover:text-gray-900 dark:text-gray-400 dark:hover:text-white focus:outline focus:outline-2 focus:rounded-sm focus:outline-red-500">Add Records</a>
            <a href="{{ route('products.showdata') }}" class="font-semibold text-gray-600 hover:text-gray-900 dark:text-gray-400 dark:hover:text-white focus:outline focus:outline-2 focus:rounded-sm focus:outline-red-500">Show Records</a>
